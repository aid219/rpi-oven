#!/usr/bin/env python3
"""
Воспроизведение GIF на SPI дисплее - с ИНВЕРСИЕЙ цветов
"""
...
def rgb_to_rgb565_inverted(r, g, b):
    """RGB888 to RGB565 с ИНВЕРСИЕЙ цветов"""
    # Инвертируем цвета: 255-r, 255-g, 255-b
    r = 255 - r
    g = 255 - g
    b = 255 - b
...
def main():
    ...
    print("Преобразование кадров с инверсией...")
    frames_bytes = []
    ...
    for i, frame in enumerate(ImageSequence.Iterator(img)):
        ...
        # Конвертируем в байты с ИНВЕРСИЕЙ
        frame_data = bytearray()
        for y in range(HEIGHT):
            for x in range(WIDTH):
                r, g, b = frame_resized.getpixel((x, y))
                frame_data.extend(rgb_to_rgb565_inverted(r, g, b))
