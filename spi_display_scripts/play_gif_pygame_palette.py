#!/usr/bin/env python3
"""
Воспроизведение GIF на SPI дисплее через pygame - с правильной обработкой палитры
"""
...
def main():
    ...
    for i, frame in enumerate(ImageSequence.Iterator(img)):
        ...
        if frame.mode == 'P':
            # Для палитровых GIF - конвертируем через palette
        ...
        if i == 0:
            ...
            print(f"  Кадр 0: {duration}ms, режим: {frame.mode}")
