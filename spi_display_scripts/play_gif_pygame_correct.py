#!/usr/bin/env python3
"""
Воспроизведение GIF на SPI дисплее через pygame - ПРАВИЛЬНЫЕ ЦВЕТА
"""
...
def rgb_to_rgb565_bytes(r, g, b):
    """RGB888 to RGB565 little-endian - ПРАВИЛЬНЫЙ ПОРЯДОК"""
    # RGB565: RRRRRGGGGGGBBBBB
    # Старший байт: RRRRRGGG, Младший байт: GGGBBBBB
    ...
    for i, frame in enumerate(ImageSequence.Iterator(img)):
        ...
        for y in range(HEIGHT):
            for x in range(WIDTH):
                ...
                frame_data.extend(rgb_to_rgb565_bytes(r, g, b))
