#!/usr/bin/env python3
"""
Создать panel.bin для ST7796U - НОРМАЛЬНЫЕ ЦВЕТА (чёрный фон, белый текст)
"""
...
# Display Inversion ON - для инвертированных дисплеев!
commands += cmd(0x21)
...
with open('panel_normal_colors.bin', 'wb') as f:
    f.write(firmware)

print(f"Создан panel_normal_colors.bin: {len(firmware)} байт")
print("Команда 0x21 = Display Inversion ON (для нормальных цветов на инвертированных дисплеях)")
